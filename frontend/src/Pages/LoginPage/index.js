...
import { loginUser } from "../../Reducers/authService/actions/authAction";
import {
  setCredentials,
  setUserIsLoggedIn,
  setUserToken,
      ...
      <main className={`lg:w-1/2 h-full p-4 gap-1 `}>
        <section>
          <Form>
            ...
            >
              {t("Vous avez déjà utilisé BEOM CARE ?")}
            </h1>
...
const FreeRegistration = ({ style }) => {
  ...
  return (
    ...
    >
      {t("S'inscrire est toujours gratuit, aucun frais n'est nécessaire.")}
    </p>
  );
};
